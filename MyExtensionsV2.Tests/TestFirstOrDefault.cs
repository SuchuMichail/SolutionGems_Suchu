...
public class TestFirstOrDefault
{
    ...
    public void WithoutFunc()
    {
        ...
        Assert.Null(list_null_string.FirstOrDefault());


        Assert.Equal(0, list_empty_int.FirstOrDefault());
        Assert.Null(list_empty_string.FirstOrDefault());
    }
    ...
    public void WithFunc()
    {
        ...
        Assert.Null(list_null_string.FirstOrDefault(o => o == "a"));
        Assert.Null(list_empty_string.FirstOrDefault(o => o == "a"));
